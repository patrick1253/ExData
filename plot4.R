# plot4.r runs a script to create the final plot required for the JHU ExData Assignment 1.
...
# open png graphics device and set params
png(file = "plot4.png",
    width = 480, height = 480, units = "px")
par(mfrow = c(2,2))

# PLOT 1,1
#change class from factor to numeric,create png graphic and save directly to png file
